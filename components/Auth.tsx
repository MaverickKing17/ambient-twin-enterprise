...
const Auth: React.FC<AuthProps> = ({ onLogin }) => {
  ...
  const roles = [
    { id: 'tech', label: 'HVAC Technician', icon: <Activity className="w-5 h-5" />, desc: 'Access Digital Twins & Telemetry' },
    { id: 'realtor', label: 'Realtor / Partner', icon: <Building2 className="w-5 h-5" />, desc: 'HER+ Portfolios & ROI Data' },
    { id: 'owner', label: 'Homeowner', icon: <UserCircle className="w-5 h-5" />, desc: 'Track Performance & Rebates' },
  ];
        ...
        <div className="flex-1 space-y-8 max-w-xl">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-blue-400/60 text-xs font-black uppercase tracking-[0.3em]">Greater Toronto Area</p>
            </div>
          </div>
          
          <div className="space-y-6">
            <h2 className="text-5xl font-black text-white leading-[1.1] tracking-tight">
              The Digital Backbone for <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-indigo-400">Toronto's HVAC</span> Industry.
            </h2>
            <p className="text-slate-400 text-lg font-medium leading-relaxed">
              Synthesize high-fidelity virtual replicas of residential climate systems. Automate HER+ grants and project ROI with precision.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-6 pt-4">
            <div className="p-5 bg-white/5 rounded-3xl border border-white/10">
              ...
              <div className="text-[10px] text-slate-500 font-bold uppercase tracking-widest">Active GTA Twins</div>
            </div>
            <div className="p-5 bg-white/5 rounded-3xl border border-white/10">
              <div className="text-2xl font-black text-emerald-400">$10.6k</div>
              <div className="text-[10px] text-slate-500 font-bold uppercase tracking-widest">Max HER+ Grant</div>
            </div>
          </div>
        </div>
        ...
        <div className="w-full max-w-[480px]">
          <div className="bg-white/10 backdrop-blur-3xl p-10 rounded-[3rem] border border-white/10 shadow-2xl space-y-8">
            <div className="space-y-2">
              <h3 className="text-2xl font-black text-white">Platform Access</h3>
              <p className="text-slate-400 text-sm">Select your enterprise role to begin synchronization.</p>
            </div>
            ...
            <div className="space-y-4 pt-4 border-t border-white/10">
              ...
              <div className="relative group">
                ...
                <input 
                  type="password" 
                  placeholder="Sync Token / Password" 
                  className="w-full bg-white/5 border border-white/10 rounded-2xl py-4 pl-12 pr-6 text-white text-sm focus:ring-2 focus:ring-blue-500/50 outline-none transition-all placeholder:text-slate-600"
                />
              </div>
            </div>
            ...
            <div className="flex items-center justify-between pt-4">
              ...
              <button className="text-[10px] font-bold text-blue-400 uppercase tracking-widest hover:text-white transition-colors">Credential Recovery</button>
            </div>
          </div>
          ...
          <div className="mt-8 flex items-center justify-center gap-3 py-3 px-6 bg-emerald-500/10 rounded-full border border-emerald-500/20 w-fit mx-auto">
            ...
            <span className="text-[9px] font-black text-emerald-600 uppercase tracking-widest">SOC 2 TYPE II END-TO-END SECURE</span>
          </div>
        </div>
      </div>
    </div>
