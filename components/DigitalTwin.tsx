    ...
    <div className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-[2.5rem] p-10 text-white relative overflow-hidden shadow-2xl border border-white/10 min-h-[580px] group">
      ...
      <div className="relative z-10 flex flex-col h-full space-y-8">
        <div className="flex justify-between items-start">
          <div>
            <div className="flex items-center gap-2 mb-1">
              <span className="text-[10px] bg-blue-600/30 text-blue-400 border border-blue-500/30 px-2 py-0.5 rounded-full font-bold uppercase tracking-widest">Virtual Home Model</span>
              <span className="text-[10px] bg-emerald-600/30 text-emerald-400 border border-emerald-500/30 px-2 py-0.5 rounded-full font-bold uppercase tracking-widest">Safety Approved</span>
            </div>
            ...
            <p className="text-slate-400 text-sm font-medium mt-1">Live Readings • System ID: TO-TR-09412</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-4">
            <DataPoint 
              label="Air Flow Pressure" 
              value={`${data.staticPressure} iwc`} 
              icon={<Activity className="w-5 h-5 text-emerald-400" />} 
              color="bg-emerald-500/20"
            />
            <DataPoint 
              label="Heating Health" 
          ...
          <div className="bg-slate-800/40 backdrop-blur-xl rounded-[2rem] p-6 border border-white/5 flex flex-col justify-between shadow-2xl">
            ...
            <div className="p-4 bg-red-500/10 border border-red-500/20 rounded-2xl flex items-start gap-3">
              ...
              <div>
                <div className="text-[10px] font-bold text-red-400 uppercase tracking-tighter">System Alert</div>
                <div className="text-[11px] text-red-100/70 leading-relaxed font-medium">Blower motor working too hard. Dispatch help within 48h.</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-auto flex items-center justify-between border-t border-white/10 pt-8">
          <div className="flex items-center gap-10">
            <div>
              <div className="text-[10px] text-slate-500 uppercase font-black tracking-[0.2em]">Efficiency</div>
              <div className="text-3xl font-black text-white italic">{data.efficiency}%</div>
            </div>
            <div className="w-px h-12 bg-white/10 hidden sm:block"></div>
            <div className="hidden sm:block">
              <div className="text-[10px] text-slate-500 uppercase font-black tracking-[0.2em]">City-Wide Rank</div>
